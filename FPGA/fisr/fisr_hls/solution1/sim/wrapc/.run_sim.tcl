...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fisr.autotvin.dat"
	set constFileTvOut       "fisr.autotvout.dat"
	set constFileHdlTvIn     "fisr.autohdltvin.dat"
	set constFileHdlTvOut    "fisr.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
